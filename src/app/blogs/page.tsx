...
const page = () => {
    return (
        <div>
            ...
            <div className="p-1 flex flex-wrap items-center justify-center" onClick={handleButtonClick2}>
                ...
                <div className="flex-shrink-0 m-6 relative overflow-hidden bg-green rounded-lg max-w-xs shadow-lg">
                    ...
                    <div className="relative text-white px-6 pb-6 mt-6">
                        <span className="block opacity-75 -mb-1"></span>
                        <div className="flex justify-between">
                            <span className="block text-xs ">چطور یک عروسی لاکچری و به‌صرفه داشته باشیم؟</span>
